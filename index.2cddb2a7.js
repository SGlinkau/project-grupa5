...
t=tx(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}let tj=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var t_=/**
...
r=tx(r),a.forEach(function(t,n){k.isUndefined(t)||null===t||e.append(!0===s?tL([r],n,o):null===s?r:r+"[]",u(t))}),!1)}}return!!tN(t)||(e.append(tL(i,r,o),u(t)),!1)}let c=[],h=Object.assign(tj,{defaultVisitor:l,convertValue:u,isVisitable:tN});if(!k.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!k.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),k.forEach(r,function(r,o){let s=!(k.isUndefined(r)||null===r)&&i.call(e,r,k.isString(o)?o.trim():o,n,h);!0===s&&t(r,n?n.concat(o):[o])}),c.pop()}}(t),e};/**
