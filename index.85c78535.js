 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&m(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(E(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=p(t)?[]:{};return S(t,(t,e)=>{let i=r(t,n+1);d(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:F,isThenable:t=>t&&(E(t)||m(t))&&m(t.then)&&m(t.catch)};/**
...
M.from=(t,e,r,n,o,i)=>{let s=Object.create($);return D.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),M.call(s,t.message,e,r,n,o),s.cause=t,s.name=t.name,i&&Object.assign(s,i),s},n=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
Object.setPrototypeOf(n,X.prototype),n)},X.prototype.readUintLE=X.prototype.readUIntLE=function(t,e,r){t>>>=0,e>>>=0,r||tf(t,e,this.length);let n=this[t],o=1,i=0;for(;++i<e&&(o*=256);)n+=this[t+i]*o;return n},X.prototype.readUintBE=X.prototype.readUIntBE=function(t,e,r){t>>>=0,e>>>=0,r||tf(t,e,this.length);let n=this[t+--e],o=1;for(;e>0&&(o*=256);)n+=this[t+--e]*o;return n},X.prototype.readUint8=X.prototype.readUInt8=function(t,e){return t>>>=0,e||tf(t,1,this.length),this[t]},X.prototype.readUint16LE=X.prototype.readUInt16LE=function(t,e){return t>>>=0,e||tf(t,2,this.length),this[t]|this[t+1]<<8},X.prototype.readUint16BE=X.prototype.readUInt16BE=function(t,e){return t>>>=0,e||tf(t,2,this.length),this[t]<<8|this[t+1]},X.prototype.readUint32LE=X.prototype.readUInt32LE=function(t,e){return t>>>=0,e||tf(t,4,this.length),(this[t]|this[t+1]<<8|this[t+2]<<16)+16777216*this[t+3]},X.prototype.readUint32BE=X.prototype.readUInt32BE=function(t,e){return t>>>=0,e||tf(t,4,this.length),16777216*this[t]+(this[t+1]<<16|this[t+2]<<8|this[t+3])},X.prototype.readBigUInt64LE=t_(function(t){tv(t>>>=0,"offset");let e=this[t],r=this[t+7];(void 0===e||void 0===r)&&tA(t,this.length-8);let n=e+256*this[++t]+65536*this[++t]+16777216*this[++t],o=this[++t]+256*this[++t]+65536*this[++t]+16777216*r;return BigInt(n)+(BigInt(o)<<BigInt(32))}),X.prototype.readBigUInt64BE=t_(function(t){tv(t>>>=0,"offset");let e=this[t],r=this[t+7];(void 0===e||void 0===r)&&tA(t,this.length-8);let n=16777216*e+65536*this[++t]+256*this[++t]+this[++t],o=16777216*this[++t]+65536*this[++t]+256*this[++t]+r;return(BigInt(n)<<BigInt(32))+BigInt(o)}),X.prototype.readIntLE=function(t,e,r){t>>>=0,e>>>=0,r||tf(t,e,this.length);let n=this[t],o=1,i=0;for(;++i<e&&(o*=256);)n+=this[t+i]*o;return n>=(o*=128)&&(n-=Math.pow(2,8*e)),n},X.prototype.readIntBE=function(t,e,r){t>>>=0,e>>>=0,r||tf(t,e,this.length);let n=e,o=1,i=this[t+--n];for(;n>0&&(o*=256);)i+=this[t+--n]*o;return i>=(o*=128)&&(i-=Math.pow(2,8*e)),i},X.prototype.readInt8=function(t,e){return(t>>>=0,e||tf(t,1,this.length),128&this[t])?-((255-this[t]+1)*1):this[t]},X.prototype.readInt16LE=function(t,e){t>>>=0,e||tf(t,2,this.length);let r=this[t]|this[t+1]<<8;return 32768&r?4294901760|r:r},X.prototype.readInt16BE=function(t,e){t>>>=0,e||tf(t,2,this.length);let r=this[t+1]|this[t]<<8;return 32768&r?4294901760|r:r},X.prototype.readInt32LE=function(t,e){return t>>>=0,e||tf(t,4,this.length),this[t]|this[t+1]<<8|this[t+2]<<16|this[t+3]<<24},X.prototype.readInt32BE=function(t,e){return t>>>=0,e||tf(t,4,this.length),this[t]<<24|this[t+1]<<16|this[t+2]<<8|this[t+3]},X.prototype.readBigInt64LE=t_(function(t){tv(t>>>=0,"offset");let e=this[t],r=this[t+7];(void 0===e||void 0===r)&&tA(t,this.length-8);let n=this[t+4]+256*this[t+5]+65536*this[t+6]+(r<<24// Overflow
...
l.send(i||null)})};const ei={http:null,xhr:eo};D.forEach(ei,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
 ...
 */class eb{constructor(t){this.defaults=t,this.interceptors={request:new t$,response:new t$}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=eh(this.defaults,e);let{transitional:o,paramsSerializer:i,headers:s}=e;void 0!==o&&ey.assertOptions(o,{silentJSONParsing:em.transitional(em.boolean),forcedJSONParsing:em.transitional(em.boolean),clarifyTimeoutError:em.transitional(em.boolean)},!1),null!=i&&(D.isFunction(i)?e.paramsSerializer={serialize:i}:ey.assertOptions(i,{encode:em.function,serialize:em.function},!0)),// Set config.method
...
const{Axios:eA,AxiosError:eO,CanceledError:eB,isCancel:eR,CancelToken:eS,VERSION:eT,all:eU,Cancel:e_,isAxiosError:eL,spread:eC,toFormData:ex,AxiosHeaders:eI,HttpStatusCode:eN,formToJSON:ej,getAdapter:eP,mergeConfig:ek}=ev,eF=document.querySelector(".header"),eD=document.createElement("ul");eD.classList.add("movies-list");const eM=document.querySelector(".not-found"),e$={};async function eq(){try{eF.after(eD);let t=await ev.get("https://api.themoviedb.org/3/trending/movie/day",{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});t.data.results.forEach(t=>{//nowe
let e=t.genre_ids.map(t=>e$[t]);eD.insertAdjacentHTML("beforeend",`<li class='movie-box'>
        ...
        </li>`)})}catch{}}async function ez(t){try{let r=document.createElement("div");eD.after(r);let n=await ev.get(`https://api.themoviedb.org/3/movie/${t}`,{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}}),o=[];n.data.genres.forEach(t=>{let e=t.name;o.push(e)});// wyswietlanie modala z poprawnymi danymi
let i=document.querySelector(".modal"),s=document.querySelector(".modal__title"),a=document.getElementById("votes"),u=document.getElementById("popularity"),l=document.getElementById("ogtitle"),f=document.getElementById("genre"),c=document.getElementById("about"),h=document.getElementById("thumbnail"),p=document.getElementsByClassName("movie-box__poster"),d=document.querySelector(".modal__icon"),g=document.querySelector("body");function e(){i.classList.remove("is-hidden"),i.classList.add("is-visible"),g.classList.add("modal__backdrop")}for(let t of p)t.addEventListener("click",e);d.addEventListener("click",function(){i.classList.add("is-hidden"),i.classList.remove("is-visible"),g.classList.remove("modal__backdrop")}),s.innerHTML=n.data.title,a.innerHTML=`${n.data.vote_average} / ${n.data.vote_count}`,u.innerHTML=n.data.popularity,l.innerHTML=n.data.original_title,f.innerHTML=[...o],c.innerHTML=n.data.overview,h.setAttribute("src",`https://www.themoviedb.org/t/p/w500${n.data.poster_path}`);// zakomentowane zeby nie tworzyl sie box pod stroną
