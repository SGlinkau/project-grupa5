...
// ================
let tv=/[^+/0-9A-Za-z-_]/g;function tR(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
t=tL(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}let tx=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var tj=/**
 ...
 *
 * @returns {void}
 */function tF(t,e){this._pairs=[],t&&tj(t,this,e)}let tD=tF.prototype;/**
...
eP.innerHTML="",e.data.results.forEach(t=>{let e=document.createElement("li");e.classList.add("movie-item");let r=`https://image.tmdb.org/t/p/w500${t.poster_path}`;e.innerHTML=`
      ...
      `,eP.appendChild(e)})}catch(t){console.error(t)}}eF();let ek=document.querySelector(".header__form"),eM=document.querySelector("#input");window.addEventListener("load",eF),ek.addEventListener("submit",t=>{t.preventDefault(),eP.replaceChildren(),eD(eM.value)})}();//# sourceMappingURL=index.2c8d0a00.js.map

//# sourceMappingURL=index.2c8d0a00.js.map
