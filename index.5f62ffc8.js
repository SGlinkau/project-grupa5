 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&v(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(O(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let i=m(t)?[]:{};return L(t,(t,e)=>{let o=r(t,n+1);b(o)||(i[e]=o)}),e[n]=void 0,i}}return t};return r(t,0)},isAsyncFn:q,isThenable:t=>t&&(O(t)||v(t))&&v(t.then)&&v(t.catch)};/**
...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return t_(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tU(t).length;default:if(i)return n?-1:t_(t).length// assume utf8
...
// ================
let tT=/[^+/0-9A-Za-z-_]/g;function t_(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
l.send(o||null)})};let el={http:null,xhr:eu};z.forEach(el,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
let o=[];for(let t=1;t<=n.data.total_pages;t++){let e=document.createElement("button");e.innerText=t,e.dataset.page=t,n.data.page===t&&e.classList.add("page-button--active"),e.addEventListener("click",eY),o.push(e)}console.log(o),eW.innerHTML="",eW.append(...o);//nowe Aga do
}catch{}}// nowe Aga od
