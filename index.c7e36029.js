...
// ================
const tO=/[^+/0-9A-Za-z-_]/g;function tR(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
t=tI(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tN=D.toFlatObject(D,{},null,function(t){return/^is[A-Z]/.test(t)});var tj=/**
 ...
 *
 * @returns {void}
 */function tF(t,e){this._pairs=[],t&&tj(t,this,e)}const tk=tF.prototype;/**
...
f.send(i||null)})};const eo={http:null,xhr:ei};D.forEach(eo,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
const eq=document.querySelector(".header__form"),ez=document.querySelector("#input");window.addEventListener("load",()=>{eM(),ek()}),eq.addEventListener("submit",t=>{t.preventDefault(),eF.replaceChildren(),eD(ez.value)}),eF.addEventListener("click",t=>{let e=t.target.getAttribute("id");e$(e)});//# sourceMappingURL=index.c7e36029.js.map

//# sourceMappingURL=index.c7e36029.js.map
