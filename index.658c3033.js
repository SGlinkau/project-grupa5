...
let{toString:f}=Object.prototype,{getPrototypeOf:u}=Object,l=(e=Object.create(null),t=>{let r=f.call(t);return e[r]||(e[r]=r.slice(8,-1).toLowerCase())}),c=t=>(t=t.toLowerCase(),e=>l(e)===t),h=t=>e=>typeof e===t,{isArray:p}=Array,d=h("undefined"),g=c("ArrayBuffer"),y=h("string"),m=h("function"),b=h("number"),w=t=>null!==t&&"object"==typeof t,E=t=>{if("object"!==l(t))return!1;let e=u(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},A=c("Date"),v=c("File"),O=c("Blob"),R=c("FileList"),B=c("URLSearchParams");/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:E,isUndefined:d,isDate:A,isFile:v,isBlob:O,isRegExp:L,isFunction:m,isStream:t=>w(t)&&m(t.pipe),isURLSearchParams:B,isTypedArray:x,isFileList:R,forEach:S,merge:/**
 ...
 */function $(t,e,r,n,i){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack,this.message=t,this.name="AxiosError",e&&(this.code=e),r&&(this.config=r),n&&(this.request=n),i&&(this.response=i)}D.inherits($,Error,{toJSON:function(){return{// Standard
message:this.message,name:this.name,// Microsoft
description:this.description,number:this.number,// Mozilla
fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,// Axios
config:D.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});let M=$.prototype,q={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(t=>{q[t]={value:t}}),Object.defineProperties($,q),Object.defineProperty(M,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
$.from=(t,e,r,n,i,o)=>{let s=Object.create(M);return D.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),$.call(s,t.message,e,r,n,i),s.cause=t,s.name=t.name,o&&Object.assign(s,o),s},n=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tR(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tB(t).length;default:if(i)return n?-1:tR(t).length// assume utf8
...
0===e.length?-1:tf(t,e,r,n,i));if("number"==typeof e)return(e&=255// Search for a byte value [0-255]
,"function"==typeof Uint8Array.prototype.indexOf)?i?Uint8Array.prototype.indexOf.call(t,e,r):Uint8Array.prototype.lastIndexOf.call(t,e,r):tf(t,[e],r,n,i);throw TypeError("val must be string, number or Buffer")}function tf(t,e,r,n,i){let o,s=1,a=t.length,f=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;s=2,a/=2,f/=2,r/=2}function u(t,e){return 1===s?t[e]:t.readUInt16BE(e*s)}if(i){let n=-1;for(o=r;o<a;o++)if(u(t,o)===u(e,-1===n?0:o-n)){if(-1===n&&(n=o),o-n+1===f)return n*s}else -1!==n&&(o-=o-n),n=-1}else for(r+f>a&&(r=a-f),o=r;o>=0;o--){let r=!0;for(let n=0;n<f;n++)if(u(t,o+n)!==u(e,n)){r=!1;break}if(r)return o}return -1}function tu(t,e,r){r=Math.min(t.length,r);let n=[],i=e;for(;i<r;){let e=t[i],o=null,s=e>239?4:e>223?3:e>191?2:1;if(i+s<=r){let r,n,a,f;switch(s){case 1:e<128&&(o=e);break;case 2:(192&(r=t[i+1]))==128&&(f=(31&e)<<6|63&r)>127&&(o=f);break;case 3:r=t[i+1],n=t[i+2],(192&r)==128&&(192&n)==128&&(f=(15&e)<<12|(63&r)<<6|63&n)>2047&&(f<55296||f>57343)&&(o=f);break;case 4:r=t[i+1],n=t[i+2],a=t[i+3],(192&r)==128&&(192&n)==128&&(192&a)==128&&(f=(15&e)<<18|(63&r)<<12|(63&n)<<6|63&a)>65535&&f<1114112&&(o=f)}}null===o?(// we did not generate a valid codePoint so insert a
...
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tw(t){let e="",r=t.length,n="-"===t[0]?1:0;for(;r>=n+4;r-=3)e=`_${t.slice(r-3,r)}${e}`;return`${t.slice(0,r)}${e}`}function tE(t,e,r,n,i,o){if(t>r||t<e){let n;let i="bigint"==typeof e?"n":"";throw n=o>3?0===e||e===BigInt(0)?`>= 0${i} and < 2${i} ** ${(o+1)*8}${i}`:`>= -(2${i} ** ${(o+1)*8-1}${i}) and < 2 ** ${(o+1)*8-1}${i}`:`>= ${e}${i} and <= ${r}${i}`,new tm.ERR_OUT_OF_RANGE("value",n,t)}tA(i,"offset"),(void 0===n[i]||void 0===n[i+o])&&tv(i,n.length-(o+1))}function tA(t,e){if("number"!=typeof t)throw new tm.ERR_INVALID_ARG_TYPE(e,"number",t)}function tv(t,e,r){if(Math.floor(t)!==t)throw tA(t,r),new tm.ERR_OUT_OF_RANGE(r||"offset","an integer",t);if(e<0)throw new tm.ERR_BUFFER_OUT_OF_BOUNDS;throw new tm.ERR_OUT_OF_RANGE(r||"offset",`>= ${r?1:0} and <= ${e}`,t)}tb("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tb("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tb("ERR_OUT_OF_RANGE",function(t,e,r){let n=`The value of "${t}" is out of range.`,i=r;return Number.isInteger(r)&&Math.abs(r)>4294967296?i=tw(String(r)):"bigint"==typeof r&&(i=String(r),(r>BigInt(2)**BigInt(32)||r<-(BigInt(2)**BigInt(32)))&&(i=tw(i)),i+="n"),n+=` It must be ${e}. Received ${i}`},RangeError);// HELPER FUNCTIONS
// ================
let tO=/[^+/0-9A-Za-z-_]/g;function tR(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
function t_(t){return"undefined"==typeof BigInt?tx:t}function tx(){throw Error("BigInt not supported")}/**
 ...
 */function tI(t){return D.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=tI(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}let tN=D.toFlatObject(D,{},null,function(t){return/^is[A-Z]/.test(t)});var tj=/**
...
return!D.isUndefined(e[t])});let n=r.metaTokens,i=r.visitor||l,o=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,f=a&&D.isSpecCompliantForm(e);if(!D.isFunction(i))throw TypeError("visitor must be a function");function u(t){if(null===t)return"";if(D.isDate(t))return t.toISOString();if(!f&&D.isBlob(t))throw new $("Blob is not supported. Use a Buffer instead.");return D.isArrayBuffer(t)||D.isTypedArray(t)?f&&"function"==typeof Blob?new Blob([t]):X.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
...
t=JSON.stringify(t);else{var f;if(D.isArray(t)&&(f=t,D.isArray(f)&&!f.some(tC))||(D.isFileList(t)||D.endsWith(r,"[]"))&&(a=D.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=tI(r),a.forEach(function(t,n){D.isUndefined(t)||null===t||e.append(!0===s?tL([r],n,o):null===s?r:r+"[]",u(t))}),!1)}}return!!tC(t)||(e.append(tL(i,r,o),u(t)),!1)}let c=[],h=Object.assign(tN,{defaultVisitor:l,convertValue:u,isVisitable:tC});if(!D.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!D.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),D.forEach(r,function(r,o){let s=!(D.isUndefined(r)||null===r)&&i.call(e,r,D.isString(o)?o.trim():o,n,h);!0===s&&t(r,n?n.concat(o):[o])}),c.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tF(t,e){this._pairs=[],t&&tj(t,this,e)}let tk=tF.prototype;/**
 ...
 */function tD(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function t$(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let i=r&&r.encode||tD,o=r&&r.serialize;if(n=o?o(e,r):D.isURLSearchParams(e)?e.toString():new tF(e,r).toString(i)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tk.append=function(t,e){this._pairs.push([t,e])},tk.toString=function(t){let e=t?function(e){return t.call(this,e,tP)}:tP;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tM=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){D.forEach(this.handlers,function(e){null!==e&&t(e)})}},tq={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tz="undefined"!=typeof URLSearchParams?URLSearchParams:tF,tH="undefined"!=typeof FormData?FormData:null,tJ="undefined"!=typeof Blob?Blob:null;/**
 ...
 */function(t){if(D.isFormData(t)&&D.isFunction(t.entries)){let e={};return D.forEachEntry(t,(t,r)=>{!function t(e,r,n,i){let o=e[i++],s=Number.isFinite(+o),a=i>=e.length;if(o=!o&&D.isArray(n)?n.length:o,a)return D.hasOwnProp(n,o)?n[o]=[n[o],r]:n[o]=r,!s;n[o]&&D.isObject(n[o])||(n[o]=[]);let f=t(e,r,n[o],i);return f&&D.isArray(n[o])&&(n[o]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(t){let e,r;let n={},i=Object.keys(t),o=i.length;for(e=0;e<o;e++)n[r=i[e]]=t[r];return n}(n[o])),!s}(D.matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),r,e,0)}),e}return null};let tY={transitional:tq,adapter:tG.isNode?"http":"xhr",transformRequest:[function(t,e){let r;let n=e.getContentType()||"",i=n.indexOf("application/json")>-1,o=D.isObject(t);o&&D.isHTMLForm(t)&&(t=new FormData(t));let s=D.isFormData(t);if(s)return i&&i?JSON.stringify(tK(t)):t;if(D.isArrayBuffer(t)||D.isBuffer(t)||D.isStream(t)||D.isFile(t)||D.isBlob(t))return t;if(D.isArrayBufferView(t))return t.buffer;if(D.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(o){if(n.indexOf("application/x-www-form-urlencoded")>-1){var a,f;return(a=t,f=this.formSerializer,tj(a,new tG.classes.URLSearchParams,Object.assign({visitor:function(t,e,r,n){return tG.isNode&&D.isBuffer(t)?(this.append(e,t.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},f))).toString()}if((r=D.isFileList(t))||n.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return tj(r?{"files[]":t}:t,e&&new e,this.formSerializer)}}return o||i?(e.setContentType("application/json",!1),/**
 ...
 */function t3(t,e,r){$.call(this,null==t?"canceled":t,$.ERR_CANCELED,e,r),this.name="CanceledError"}t5.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),D.reduceDescriptors(t5.prototype,({value:t},e)=>{let r=e[0].toUpperCase()+e.slice(1);// map `set` => `Set`
return{get:()=>t,set(t){this[r]=t}}}),D.freezeMethods(t5),D.inherits(t3,$,{__CANCEL__:!0});var t7=tG.isStandardBrowserEnv?{write:function(t,e,r,n,i,o){let s=[];s.push(t+"="+encodeURIComponent(e)),D.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),D.isString(n)&&s.push("path="+n),D.isString(i)&&s.push("domain="+i),!0===o&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function t9(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var et=tG.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
 ...
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),i=Array(t),o=0,s=0;return e=void 0!==e?e:1e3,function(a){let f=Date.now(),u=i[s];r||(r=f),n[o]=a,i[o]=f;let l=s,c=0;for(;l!==o;)c+=n[l++],l%=t;if((o=(o+1)%t)===s&&(s=(s+1)%t),f-r<e)return;let h=u&&f-u;return h?Math.round(1e3*c/h):void 0}};function er(t,e){let r=0,n=ee(50,250);return i=>{let o=i.loaded,s=i.lengthComputable?i.total:void 0,a=o-r,f=n(a),u=o<=s;r=o;let l={loaded:o,total:s,progress:s?o/s:void 0,bytes:a,rate:f||void 0,estimated:f&&s&&u?(s-o)/f:void 0,event:i};l[e?"download":"upload"]=!0,t(l)}}let en="undefined"!=typeof XMLHttpRequest;var ei=en&&function(t){return new Promise(function(e,r){let n,i=t.data,o=t5.from(t.headers).normalize(),s=t.responseType;function a(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}D.isFormData(i)&&(tG.isStandardBrowserEnv||tG.isStandardBrowserWebWorkerEnv?o.setContentType(!1):o.setContentType("multipart/form-data;",!1));let f=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";o.set("Authorization","Basic "+btoa(e+":"+r))}let u=t9(t.baseURL,t.url);function l(){if(!f)return;// Prepare the response
let n=t5.from("getAllResponseHeaders"in f&&f.getAllResponseHeaders()),i=s&&"text"!==s&&"json"!==s?f.response:f.responseText,o={data:i,status:f.status,statusText:f.statusText,headers:n,config:t,request:f};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new $("Request failed with status code "+r.status,[$.ERR_BAD_REQUEST,$.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),a()},function(t){r(t),a()},o),// Clean up request
f=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(f.open(t.method.toUpperCase(),t$(u,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
f.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tq;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new $(e,n.clarifyTimeoutError?$.ETIMEDOUT:$.ECONNABORTED,t,f)),// Clean up request
f=null},tG.isStandardBrowserEnv){// Add xsrf header
let e=(t.withCredentials||et(u))&&t.xsrfCookieName&&t7.read(t.xsrfCookieName);e&&o.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===i&&o.setContentType(null),"setRequestHeader"in f&&D.forEach(o.toJSON(),function(t,e){f.setRequestHeader(e,t)}),D.isUndefined(t.withCredentials)||(f.withCredentials=!!t.withCredentials),s&&"json"!==s&&(f.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&f.addEventListener("progress",er(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&f.upload&&f.upload.addEventListener("progress",er(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{f&&(r(!e||e.type?new t3(null,t,f):e),f.abort(),f=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let c=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(u);if(c&&-1===tG.protocols.indexOf(c)){r(new $("Unsupported protocol "+c+":",$.ERR_BAD_REQUEST,t));return}// Send the request
f.send(i||null)})};let eo={http:null,xhr:ei};D.forEach(eo,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});var es={getAdapter:t=>{let e,r;t=D.isArray(t)?t:[t];let{length:n}=t;for(let i=0;i<n&&(e=t[i],!(r=D.isString(e)?eo[e.toLowerCase()]:e));i++);if(!r){if(!1===r)throw new $(`Adapter ${e} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(D.hasOwnProp(eo,e)?`Adapter '${e}' is not available in the build`:`Unknown adapter '${e}'`)}if(!D.isFunction(r))throw TypeError("adapter is not a function");return r},adapters:eo};/**
...
e.data=t8.call(t,t.transformResponse,e),e.headers=t5.from(e.headers),e},function(e){return!t4(e)&&(ea(t),e&&e.response&&(e.response.data=t8.call(t,t.transformResponse,e.response),e.response.headers=t5.from(e.response.headers))),Promise.reject(e)})}let eu=t=>t instanceof t5?t.toJSON():t;function el(t,e){// eslint-disable-next-line no-param-reassign
...
function a(r,i,o){return o in e?n(r,i):o in t?n(void 0,r):void 0}let f={url:o,method:o,data:o,baseURL:s,transformRequest:s,transformResponse:s,paramsSerializer:s,timeout:s,timeoutMessage:s,withCredentials:s,adapter:s,responseType:s,xsrfCookieName:s,xsrfHeaderName:s,onUploadProgress:s,onDownloadProgress:s,decompress:s,maxContentLength:s,maxBodyLength:s,beforeRedirect:s,transport:s,httpAgent:s,httpsAgent:s,cancelToken:s,socketPath:s,responseEncoding:s,validateStatus:a,headers:(t,e)=>i(eu(t),eu(e),!0)};return D.forEach(Object.keys(Object.assign({},t,e)),function(n){let o=f[n]||i,s=o(t[n],e[n],n);D.isUndefined(s)&&o!==a||(r[n]=s)}),r}let ec="1.5.0",eh={};// eslint-disable-next-line func-names
...
return(r,i,o)=>{if(!1===t)throw new $(n(i," has been removed"+(e?" in "+e:"")),$.ERR_DEPRECATED);return e&&!ep[i]&&(ep[i]=!0,// eslint-disable-next-line no-console
...
ew.Axios=ey,// Expose Cancel & CancelToken
ew.CanceledError=t3,ew.CancelToken=em,ew.isCancel=t4,ew.VERSION=ec,ew.toFormData=tj,// Expose AxiosError class
ew.AxiosError=$,// alias for CanceledError for backward compatibility
ew.Cancel=ew.CanceledError,// Expose all/spread
ew.all=function(t){return Promise.all(t)},ew.spread=function(t){return function(e){return t.apply(null,e)}},// Expose isAxiosError
ew.isAxiosError=function(t){return D.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
ew.mergeConfig=el,ew.AxiosHeaders=t5,ew.formToJSON=t=>tK(D.isHTMLForm(t)?new FormData(t):t),ew.getAdapter=es.getAdapter,ew.HttpStatusCode=eb,ew.default=ew;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:eE,AxiosError:eA,CanceledError:ev,isCancel:eO,CancelToken:eR,VERSION:eB,all:eS,Cancel:eT,isAxiosError:eU,spread:e_,toFormData:ex,AxiosHeaders:eC,HttpStatusCode:eI,formToJSON:eL,getAdapter:eN,mergeConfig:ej}=ew,eP=document.querySelector(".header"),eF=document.createElement("ul");async function ek(){try{eP.after(eF);let t=await ew.get("https://api.themoviedb.org/3/trending/movie/day",{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});t.data.results.forEach(t=>{eF.insertAdjacentHTML("beforeend",`<li class='movie-box'>
        ...
        <p class='movie-box__info'>${t.genre_ids.join(", ")} | ${t.release_date.slice(0,4)}</p>
        </li>`)})}catch{}}async function eD(t){try{let e=await ew.get("https://api.themoviedb.org/3/search/movie",{params:{query:`${t}`,api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});e.data.results.forEach(t=>{eF.insertAdjacentHTML("beforeend",`<li class='movie-box'>
        <a class='movie-box__link'>
        <img class='movie-box__poster' id=${t.id} src='https://www.themoviedb.org/t/p/w500${t.poster_path}' />
        </a>
        <h2 class='movie-box__title'>${t.title}</h2>
        <p class='movie-box__info'>${t.genre_ids.join(", ")} | ${t.release_date.slice(0,4)}</p>
        </li>`)})}catch{}}async function e$(t){try{let e=document.createElement("div");eF.after(e);let r=await ew.get(`https://api.themoviedb.org/3/movie/${t}`,{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}}),n=[];r.data.genres.forEach(t=>{let e=t.name;n.push(e)}),e.insertAdjacentHTML("afterbegin",`<img src='https://www.themoviedb.org/t/p/w500${r.data.poster_path}'/>
      <h2>${r.data.title}</h2>
      ...
      <p>Genre ${[...n]}</p>
    <p>ABOUT: ${r.data.overview}</p>`)}catch{}}async function eM(){try{let t=await ew.get("https://api.themoviedb.org/3/genre/movie/list",{params:{language:"en",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});console.log(t.data)}catch{}}// import axios from 'axios';
eF.classList.add("movies-list");// export const moviesList = document.querySelector('.movies-list');
...
let eq=document.querySelector(".header__form"),ez=document.querySelector("#input");window.addEventListener("load",()=>{eM(),ek()}),eq.addEventListener("submit",t=>{t.preventDefault(),eF.replaceChildren(),eD(ez.value)}),eF.addEventListener("click",t=>{let e=t.target.getAttribute("id");e$(e)})}();//# sourceMappingURL=index.658c3033.js.map

//# sourceMappingURL=index.658c3033.js.map
