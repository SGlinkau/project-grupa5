!function(){var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},a={},i=e.parcelRequire9b51;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in a){var i=a[e];delete a[e];var o={id:e,exports:{}};return t[e]=o,i.call(o.exports,o,o.exports),o.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){a[e]=t},e.parcelRequire9b51=i);var o=i("dIxxU"),r=i("446fK");let n=document.querySelector(".library-list"),l=document.querySelector("#watched-btn"),s=document.querySelector("#queue-btn");async function c(){n.replaceChildren();let e=JSON.parse(localStorage.getItem("watchedList"));e.forEach(async e=>{let t=await (0,o.default).get(`https://api.themoviedb.org/3/movie/${e.id}`,{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}}),a=[];t.data.genres.forEach(e=>a.push(e.name));let i=t.data.poster_path?`https://www.themoviedb.org/t/p/w500${t.data.poster_path}`:noPosterURL;n.insertAdjacentHTML("beforeend",`<li class='movie-box'>
...
s.addEventListener("click",()=>{d()}),l.addEventListener("click",()=>{c()}),n.addEventListener("click",e=>{if("IMG"!==e.target.nodeName)return;let t=e.target.getAttribute("id");(0,r.getDetails)(t)}),n.addEventListener("click",e=>{if("BUTTON"!==e.target.nodeName)return;let t=e.target.getAttribute("id");(0,r.getTrailer)(t)});// const addToQueueButton = document.getElementById('add__queue-btn');
...
//   }
// }
}();//# sourceMappingURL=myLibrary.3d0c95da.js.map
