 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:E,isPlainObject:w,isUndefined:d,isDate:A,isFile:O,isBlob:v,isRegExp:_,isFunction:m,isStream:t=>E(t)&&m(t.pipe),isURLSearchParams:B,isTypedArray:I,isFileList:R,forEach:S,merge:/**
...
// ================
const tv=/[^+/0-9A-Za-z-_]/g;function tR(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
(t=t.split("=")[0]).trim().replace(tv,"")).length<2)return"";// Node allows for non-padded base64 strings (missing trailing ===), base64-js does not
 ...
 */function t_(t,e,r){return t?t.concat(e).map(function(t,e){return(// eslint-disable-next-line no-param-reassign
t=tL(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tx=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var tj=/**
...
t=JSON.stringify(t);else{var u;if(k.isArray(t)&&(u=t,k.isArray(u)&&!u.some(tN))||(k.isFileList(t)||k.endsWith(r,"[]"))&&(a=k.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=tL(r),a.forEach(function(t,n){k.isUndefined(t)||null===t||e.append(!0===s?t_([r],n,o):null===s?r:r+"[]",f(t))}),!1)}}return!!tN(t)||(e.append(t_(i,r,o),f(t)),!1)}let c=[],h=Object.assign(tx,{defaultVisitor:l,convertValue:f,isVisitable:tN});if(!k.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!k.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),k.forEach(r,function(r,o){let s=!(k.isUndefined(r)||null===r)&&i.call(e,r,k.isString(o)?o.trim():o,n,h);!0===s&&t(r,n?n.concat(o):[o])}),c.pop()}}(t),e};/**
...
u.send(i||null)})};const eo={http:null,xhr:ei};k.forEach(eo,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
 ...
 */class ey{constructor(t){this.defaults=t,this.interceptors={request:new t$,response:new t$}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=el(this.defaults,e);let{transitional:i,paramsSerializer:o,headers:s}=e;void 0!==i&&ed.assertOptions(i,{silentJSONParsing:eg.transitional(eg.boolean),forcedJSONParsing:eg.transitional(eg.boolean),clarifyTimeoutError:eg.transitional(eg.boolean)},!1),null!=o&&(k.isFunction(o)?e.paramsSerializer={serialize:o}:ed.assertOptions(o,{encode:eg.function,serialize:eg.function},!0)),// Set config.method
...
let u=[],f=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(f=f&&t.synchronous,u.unshift(t.fulfilled,t.rejected))});let l=[];this.interceptors.response.forEach(function(t){l.push(t.fulfilled,t.rejected)});let c=0;if(!f){let t=[eu.bind(this),void 0];for(t.unshift.apply(t,u),t.push.apply(t,l),n=t.length,r=Promise.resolve(e);c<n;)r=r.then(t[c++],t[c++]);return r}n=u.length;let h=e;for(c=0;c<n;){let t=u[c++],e=u[c++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=eu.call(this,h)}catch(t){return Promise.reject(t)}for(c=0,n=l.length;c<n;)r=r.then(l[c++],l[c++]);return r}getUri(t){t=el(this.defaults,t);let e=t9(t.baseURL,t.url);return tM(e,t.params,t.paramsSerializer)}}k.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/ey.prototype[t]=function(e,r){return this.request(el(r||{},{method:t,url:e,data:(r||{}).data}))}}),k.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,i){return this.request(el(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}ey.prototype[t]=e(),ey.prototype[t+"Form"]=e(!0)});/**
 ...
 */function t(e){let r=new ey(e),n=a(ey.prototype.request,r);return k.extend(n,ey.prototype,r,{allOwnKeys:!0}),k.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
...
const{Axios:ew,AxiosError:eA,CanceledError:eO,isCancel:ev,CancelToken:eR,VERSION:eB,all:eS,Cancel:eT,isAxiosError:eU,spread:eC,toFormData:eI,AxiosHeaders:eN,HttpStatusCode:eL,formToJSON:e_,getAdapter:ex,mergeConfig:ej}=eE,eP=document.querySelector(".movies-list");async function eF(){try{let t=await eE.get("https://api.themoviedb.org/3/trending/movie/day",{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});// Wyczyść listę filmów przed dodaniem nowych filmów
eP.innerHTML="",t.data.results.forEach(t=>{let e=document.createElement("li");e.classList.add("movie-item");let r=`https://image.tmdb.org/t/p/w500${t.poster_path}`;e.innerHTML=`
        <div class="movie-poster">
          <img src="${r}" alt="${t.title}" />
        </div>
        <div class="movie-details">
          <h2 class="movie-title">${t.title}</h2>
          <p class="movie-genre">Genres: ${t.genre_ids.join(", ")}</p>
          <p class="movie-year">Release Year: ${t.release_date?t.release_date.slice(0,4):"N/A"}</p>
        </div>
      `,eP.appendChild(e)})}catch(t){console.error(t)}}async function eD(t){try{let e=await eE.get("https://api.themoviedb.org/3/search/movie",{params:{query:t,api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});// Wyczyść listę filmów przed dodaniem nowych filmów
eP.innerHTML="",e.data.results.forEach(t=>{let e=document.createElement("li");e.classList.add("movie-item");let r=`https://image.tmdb.org/t/p/w500${t.poster_path}`;e.innerHTML=`
        <div class="movie-poster">
          <img src="${r}" alt="${t.title}" />
        </div>
        <div class="movie-details">
      ...
      `,eP.appendChild(e)})}catch(t){console.error(t)}}eF();const ek=document.querySelector(".header__form"),eM=document.querySelector("#input");window.addEventListener("load",eF),ek.addEventListener("submit",t=>{t.preventDefault(),eP.replaceChildren(),eD(eM.value)});//# sourceMappingURL=index.b7a88d0e.js.map

//# sourceMappingURL=index.b7a88d0e.js.map
