...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tB(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tR(t).length;default:if(i)return n?-1:tB(t).length// assume utf8
...
// ================
const tO=/[^+/0-9A-Za-z-_]/g;function tB(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
if(i=null,r<128){if((e-=1)<0)break;o.push(r)}else if(r<2048){if((e-=2)<0)break;o.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;o.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;o.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return o}function tR(t){return function(t){var e,r,n=function(t){var e=t.length;if(e%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
...
return!D.isUndefined(e[t])});let n=r.metaTokens,i=r.visitor||f,o=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,u=a&&D.isSpecCompliantForm(e);if(!D.isFunction(i))throw TypeError("visitor must be a function");function l(t){if(null===t)return"";if(D.isDate(t))return t.toISOString();if(!u&&D.isBlob(t))throw new M("Blob is not supported. Use a Buffer instead.");return D.isArrayBuffer(t)||D.isTypedArray(t)?u&&"function"==typeof Blob?new Blob([t]):X.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
 ...
 *
 * @returns {void}
 */function tk(t,e){this._pairs=[],t&&tj(t,this,e)}const tF=tk.prototype;/**
...
let n=t5.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),i=a&&"text"!==a&&"json"!==a?l.response:l.responseText,o={data:i,status:l.status,statusText:l.statusText,headers:n,config:t,request:l};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new M("Request failed with status code "+r.status,[M.ERR_BAD_REQUEST,M.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),u()},function(t){r(t),u()},o),// Clean up request
...
l.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tq;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new M(e,n.clarifyTimeoutError?M.ETIMEDOUT:M.ECONNABORTED,t,l)),// Clean up request
...
l.send(o||null)})};const eo={http:null,xhr:ei};D.forEach(eo,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});const es=t=>`- ${t}`,ea=t=>D.isFunction(t)||null===t||!1===t;var eu={getAdapter:t=>{let e,r;t=D.isArray(t)?t:[t];let{length:n}=t,i={};for(let o=0;o<n;o++){let n;if(r=e=t[o],!ea(e)&&void 0===(r=eo[(n=String(e)).toLowerCase()]))throw new M(`Unknown adapter '${n}'`);if(r)break;i[n||"#"+o]=r}if(!r){let t=Object.entries(i).map(([t,e])=>`adapter ${t} `+(!1===e?"is not supported by the environment":"is not available in the build")),e=n?t.length>1?"since :\n"+t.map(es).join("\n"):" "+es(t[0]):"as no adapter specified";throw new M("There is no suitable adapter to dispatch the request "+e,"ERR_NOT_SUPPORT")}return r},adapters:eo};/**
...
return(r,i,o)=>{if(!1===t)throw new M(n(i," has been removed"+(e?" in "+e:"")),M.ERR_DEPRECATED);return e&&!eg[i]&&(eg[i]=!0,// eslint-disable-next-line no-console
...
ev.CanceledError=t3,ev.CancelToken=eE,ev.isCancel=t4,ev.VERSION=ep,ev.toFormData=tj,// Expose AxiosError class
...
const{Axios:eA,AxiosError:eO,CanceledError:eB,isCancel:eR,CancelToken:eS,VERSION:eT,all:eU,Cancel:e_,isAxiosError:eL,spread:eC,toFormData:ex,AxiosHeaders:eI,HttpStatusCode:eN,formToJSON:ej,getAdapter:eP,mergeConfig:ek}=ev,eF=document.querySelector(".header"),eD=document.createElement("ul");eD.classList.add("movies-list");const eM=document.querySelector(".not-found"),e$={},eq=document.querySelector("#pages");async function ez(){try{eF.after(eD);let t=await ev.get("https://api.themoviedb.org/3/trending/movie/day",{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}});t.data.results.forEach(t=>{//nowe
