 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&E(t.buffer)},isString:w,isNumber:A,isBoolean:t=>!0===t||!1===t,isObject:O,isPlainObject:B,isUndefined:b,isDate:R,isFile:S,isBlob:T,isRegExp:k,isFunction:v,isStream:t=>O(t)&&v(t.pipe),isURLSearchParams:U,isTypedArray:N,isFileList:_,forEach:L,merge:/**
 ...
 */function t(){let{caseless:e}=I(this)&&this||{},r={},n=(n,o)=>{let i=e&&x(r,o)||o;B(r[i])&&B(n)?r[i]=t(r[i],n):B(n)?r[i]=t({},n):m(n)?r[i]=n.slice():r[i]=n};for(let t=0,e=arguments.length;t<e;t++)arguments[t]&&L(arguments[t],n);return r},extend:(t,e,r,{allOwnKeys:n}={})=>(L(e,(e,n)=>{r&&v(e)?t[n]=c(e,r):t[n]=e},{allOwnKeys:n}),t),trim:t=>t.trim?t.trim():t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:t=>(65279===t.charCodeAt(0)&&(t=t.slice(1)),t),inherits:(t,e,r,n)=>{t.prototype=Object.create(e.prototype,n),t.prototype.constructor=t,Object.defineProperty(t,"super",{value:e.prototype}),r&&Object.assign(t.prototype,r)},toFlatObject:(t,e,r,n)=>{let o,i,s;let a={};// eslint-disable-next-line no-eq-null,eqeqeq
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&v(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(O(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=m(t)?[]:{};return L(t,(t,e)=>{let i=r(t,n+1);b(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:q,isThenable:t=>t&&(O(t)||v(t))&&v(t.then)&&v(t.catch)};/**
...
H.from=(t,e,r,n,o,i)=>{let s=Object.create(J);return z.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),H.call(s,t.message,e,r,n,o),s.cause=t,s.name=t.name,i&&Object.assign(s,i),s},o=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
for(var e,r=t.length,n=r%3// if we have 1 byte left, pad 2 bytes
,o=[],i=0,s=r-n;i<s;i+=16383// must be multiple of 3
)o.push(function(t,e,r){for(var n,o=[],i=e;i<r;i+=3)o.push(W[(n=(t[i]<<16&16711680)+(t[i+1]<<8&65280)+(255&t[i+2]))>>18&63]+W[n>>12&63]+W[n>>6&63]+W[63&n]);return o.join("")}(t,i,i+16383>s?s:i+16383));return 1===n?o.push(W[(e=t[r-1])>>2]+W[e<<4&63]+"=="):2===n&&o.push(W[(e=(t[r-2]<<8)+t[r-1])>>10]+W[e>>4&63]+W[e<<2&63]+"="),o.join("")};for(var W=[],G=[],K="undefined"!=typeof Uint8Array?Uint8Array:Array,Y="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",X=0,Q=Y.length;X<Q;++X)W[X]=Y[X],G[Y.charCodeAt(X)]=X;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
G["-".charCodeAt(0)]=62,G["_".charCodeAt(0)]=63,i=function(t,e,r,n,o){var i,s,a=8*o-n-1,u=(1<<a)-1,l=u>>1,f=-7,c=r?o-1:0,h=r?-1:1,p=t[e+c];for(c+=h,i=p&(1<<-f)-1,p>>=-f,f+=a;f>0;i=256*i+t[e+c],c+=h,f-=8);for(s=i&(1<<-f)-1,i>>=-f,f+=n;f>0;s=256*s+t[e+c],c+=h,f-=8);if(0===i)i=1-l;else{if(i===u)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),i-=l}return(p?-1:1)*s*Math.pow(2,i-n)},s=function(t,e,r,n,o,i){var s,a,u,l=8*i-o-1,f=(1<<l)-1,c=f>>1,h=23===o?5960464477539062e-23:0,p=n?0:i-1,d=n?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=f):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),s+c>=1?e+=h/u:e+=h*Math.pow(2,1-c),e*u>=2&&(s++,u/=2),s+c>=f?(a=0,s=f):s+c>=1?(a=(e*u-1)*Math.pow(2,o),s+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,o),s=0));o>=8;t[r+p]=255&a,p+=d,a/=256,o-=8);for(s=s<<o|a,l+=o;l>0;t[r+p]=255&s,p+=d,s/=256,l-=8);t[r+p-d]|=128*g};const Z="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
if("number"==typeof t){if("string"==typeof e)throw TypeError('The "string" argument must be of type string. Received type number');return to(t)}return tr(t,e,r)}function tr(t,e,r){if("string"==typeof t)return function(t,e){if(("string"!=typeof e||""===e)&&(e="utf8"),!te.isEncoding(e))throw TypeError("Unknown encoding: "+e);let r=0|tu(t,e),n=tt(r),o=n.write(t,e);return o!==r&&// cause everything after the first invalid character to be ignored. (e.g.
...
let o=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return t_(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tU(t).length;default:if(o)return n?-1:t_(t).length// assume utf8
;e=(""+e).toLowerCase(),o=!0}}function tl(t,e,r){let n=!1;// Return early if start > this.length. Done here to prevent potential uint32
// coercion fail below.
...
for(let t=0;t<n.length-1;t+=2)o+=String.fromCharCode(n[t]+256*n[t+1]);return o}(this,e,r);default:if(n)throw TypeError("Unknown encoding: "+t);t=(t+"").toLowerCase(),n=!0}}function tf(t,e,r){let n=t[e];t[e]=t[r],t[r]=n}// Finds either the first index of `val` in `buffer` at offset >= `byteOffset`,
...
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(t,e,r):Uint8Array.prototype.lastIndexOf.call(t,e,r):th(t,[e],r,n,o);throw TypeError("val must be string, number or Buffer")}function th(t,e,r,n,o){let i,s=1,a=t.length,u=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;s=2,a/=2,u/=2,r/=2}function l(t,e){return 1===s?t[e]:t.readUInt16BE(e*s)}if(o){let n=-1;for(i=r;i<a;i++)if(l(t,i)===l(e,-1===n?0:i-n)){if(-1===n&&(n=i),i-n+1===u)return n*s}else -1!==n&&(i-=i-n),n=-1}else for(r+u>a&&(r=a-u),i=r;i>=0;i--){let r=!0;for(let n=0;n<u;n++)if(l(t,i+n)!==l(e,n)){r=!1;break}if(r)return i}return -1}function tp(t,e,r){r=Math.min(t.length,r);let n=[],o=e;for(;o<r;){let e=t[o],i=null,s=e>239?4:e>223?3:e>191?2:1;if(o+s<=r){let r,n,a,u;switch(s){case 1:e<128&&(i=e);break;case 2:(192&(r=t[o+1]))==128&&(u=(31&e)<<6|63&r)>127&&(i=u);break;case 3:r=t[o+1],n=t[o+2],(192&r)==128&&(192&n)==128&&(u=(15&e)<<12|(63&r)<<6|63&n)>2047&&(u<55296||u>57343)&&(i=u);break;case 4:r=t[o+1],n=t[o+2],a=t[o+3],(192&r)==128&&(192&n)==128&&(192&a)==128&&(u=(15&e)<<18|(63&r)<<12|(63&n)<<6|63&a)>65535&&u<1114112&&(i=u)}}null===i?(// we did not generate a valid codePoint so insert a
...
if(o=null,r<128){if((e-=1)<0)break;i.push(r)}else if(r<2048){if((e-=2)<0)break;i.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;i.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;i.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return i}function tU(t){return function(t){var e,r,n=function(t){var e=t.length;if(e%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
// See: https://github.com/beatgammit/base64-js/issues/42
var r=t.indexOf("=");-1===r&&(r=e);var n=r===e?0:4-r%4;return[r,n]}(t),o=n[0],i=n[1],s=new K((o+i)*3/4-i),a=0,u=i>0?o-4:o;for(r=0;r<u;r+=4)e=G[t.charCodeAt(r)]<<18|G[t.charCodeAt(r+1)]<<12|G[t.charCodeAt(r+2)]<<6|G[t.charCodeAt(r+3)],s[a++]=e>>16&255,s[a++]=e>>8&255,s[a++]=255&e;return 2===i&&(e=G[t.charCodeAt(r)]<<2|G[t.charCodeAt(r+1)]>>4,s[a++]=255&e),1===i&&(e=G[t.charCodeAt(r)]<<10|G[t.charCodeAt(r+1)]<<4|G[t.charCodeAt(r+2)]>>2,s[a++]=e>>8&255,s[a++]=255&e),s}(function(t){// Node converts strings with length < 2 to ''
...
r=tP(r),a.forEach(function(t,n){z.isUndefined(t)||null===t||e.append(!0===s?tk([r],n,i):null===s?r:r+"[]",l(t))}),!1)}}return!!tj(t)||(e.append(tk(o,r,i),l(t)),!1)}let c=[],h=Object.assign(tF,{defaultVisitor:f,convertValue:l,isVisitable:tj});if(!z.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!z.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),z.forEach(r,function(r,i){let s=!(z.isUndefined(r)||null===r)&&o.call(e,r,z.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
...
let e=(t.withCredentials||eo(f))&&t.xsrfCookieName&&er.read(t.xsrfCookieName);e&&s.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
...
return(r,o,i)=>{if(!1===t)throw new H(n(o," has been removed"+(e?" in "+e:"")),H.ERR_DEPRECATED);return e&&!eE[o]&&(eE[o]=!0,// eslint-disable-next-line no-console
 ...
 *
 * @returns {object}
 */function(t,e,r){if("object"!=typeof t)throw new H("options must be an object",H.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),o=n.length;for(;o-- >0;){let i=n[o],s=e[i];if(s){let e=t[i],r=void 0===e||s(e,i,t);if(!0!==r)throw new H("option "+i+" must be "+r,H.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new H("Unknown option "+i,H.ERR_BAD_OPTION)}},validators:eb};const ev=ew.validators;/**
 ...
 */class eA{constructor(t){this.defaults=t,this.interceptors={request:new tJ,response:new tJ}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=ey(this.defaults,e);let{transitional:o,paramsSerializer:i,headers:s}=e;void 0!==o&&ew.assertOptions(o,{silentJSONParsing:ev.transitional(ev.boolean),forcedJSONParsing:ev.transitional(ev.boolean),clarifyTimeoutError:ev.transitional(ev.boolean)},!1),null!=i&&(z.isFunction(i)?e.paramsSerializer={serialize:i}:ew.assertOptions(i,{encode:ev.function,serialize:ev.function},!0)),// Set config.method
...
let r=t.genre_ids.map(t=>eV[t]),n=t.poster_path?`https://www.themoviedb.org/t/p/w500${t.poster_path}`:/*@__PURE__*/e(eq);eH.insertAdjacentHTML("beforeend",`<li class='movie-box'>
        ...
        </li>`)})}catch{}}async function eK(t,r=1){try{let n=await eR.get("https://api.themoviedb.org/3/search/movie",{params:{query:`${t}`,page:`${r}`,api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}}),o=n.data.results;0===o.length&&eJ.classList.remove("is-hidden"),o.forEach(t=>{//nowe
let r=t.genre_ids.map(t=>eV[t]),n=t.poster_path?`https://www.themoviedb.org/t/p/w500${t.poster_path}`:/*@__PURE__*/e(eq);eH.insertAdjacentHTML("beforeend",`<li class='movie-box'>
        <a class='movie-box__link'>
        <button class='movie-box__trailer-button' type='button' id=${t.id}>Trailer</button>
        <img class='movie-box__poster' id=${t.id} src='${n}' />
...
let i=[];for(let t=1;t<=n.data.total_pages;t++){let e=document.createElement("button");e.innerText=t,e.dataset.page=t,n.data.page===t&&e.classList.add("page-button--active"),e.addEventListener("click",eY),i.push(e)}console.log(i),eW.innerHTML="",eW.append(...i);//nowe Aga do
}catch{}}// nowe Aga od
function eY(){eH.replaceChildren(),eK(input.value,this.dataset.page)}async function eX(t){try{let n=document.createElement("div");eH.after(n);let o=await eR.get(`https://api.themoviedb.org/3/movie/${t}`,{params:{language:"en-US",api_key:"c90cdec037818042646f6ab3cec9ea66"},headers:{accept:"application/json"}}),i=[];o.data.genres.forEach(t=>{let e=t.name;i.push(e)});// wyswietlanie modala z poprawnymi danymi
let s=document.querySelector(".modal"),a=document.querySelector(".modal__title"),u=document.getElementById("votes"),l=document.getElementById("popularity"),f=document.getElementById("ogtitle"),c=document.getElementById("genre"),h=document.getElementById("about"),p=document.getElementById("thumbnail"),d=document.getElementsByClassName("movie-box__poster"),g=document.querySelector(".modal__icon"),y=document.querySelector("body"),m=o.data.poster_path?`https://www.themoviedb.org/t/p/w500${o.data.poster_path}`:/*@__PURE__*/e(eq);function r(){s.classList.remove("is-hidden"),s.classList.add("is-visible"),y.classList.add("modal__backdrop")}for(let t of d)t.addEventListener("click",r);g.addEventListener("click",function(){s.classList.add("is-hidden"),s.classList.remove("is-visible"),y.classList.remove("modal__backdrop")}),a.innerHTML=o.data.title,u.innerHTML=`${o.data.vote_average} / ${o.data.vote_count}`,l.innerHTML=o.data.popularity,f.innerHTML=o.data.original_title,c.innerHTML=[...i],h.innerHTML=o.data.overview,p.setAttribute("src",`${m}`);// zakomentowane zeby nie tworzyl sie box pod stroną
